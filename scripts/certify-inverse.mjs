...
import { rankAndCertify } from '../lib/quant/inference.js';
import { exhaustiveOptimum } from '../lib/quant/certify.js';
import { groupedCorpus } from '../lib/quant/corpus.js';
...
const result = {
  schema: 'sicc-inverse-certification-v1', generatedBy: 'scripts/certify-inverse.mjs',
