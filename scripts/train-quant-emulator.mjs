#!/usr/bin/env node
/**
 * Trains the dependency-free learned emulators and writes data/quant-emulator.json.
 *
 * Honesty contract:
...
import { rng, hash } from '../lib/quant/statistics.js';
import { forward, getModel, MODELS } from '../lib/quant/renderer.js';
import {
