 ...
 * See docs/engineering/archive/v0.4-conversion-improvement-plan.md §2.7 and Phase 5.
 */
import { readFile, writeFile } from 'node:fs/promises';
import { gateDecision, CLOSED_GATE, MODULATOR_VERSION, DELTA_CLIP, REVIEWED_REGISTRY_PROVENANCE } from '../../research/lib/modulator.js';
...
await writeFile(new URL('research/generated/quant-modulator.json', root), JSON.stringify(artifact, null, 2) + '\n');
