 ...
 * It never runs CS2. See docs/engineering/archive/v0.4-conversion-improvement-plan.md §3.3.
 */
import { readFile, writeFile, mkdir } from 'node:fs/promises';
import { invertStructural, structuralForward, enumerateReducedFamily, DEFAULT_PHI } from '../../lib/solver/structural.js';
