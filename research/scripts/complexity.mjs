...
async function inventory(root) {
 ...
 for(const folder of ['app','lib','research/lib','research/scripts','scripts'])await walk(join(root,folder));
...
if(args.includes('--save'))await writeFile(new URL('../../research/generated/complexity-local.json',import.meta.url),JSON.stringify(report,null,2)+'\n');
