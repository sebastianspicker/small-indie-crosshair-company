...
import { NEW_CVARS } from '../../lib/settings/cvars.js';
import { pixelCopyCandidate, renameCandidate, rivalSummary, structuralCandidate } from '../../lib/solver/migration.js';
import {
