...
import { posterior, residualSquared } from '../../lib/solver/evidence.js';
import { getModel } from '../../lib/solver/renderer.js';
import { RASTER_CONVENTION, RAW_EDGE_CONVENTION } from '../../lib/geometry/raster.js';
