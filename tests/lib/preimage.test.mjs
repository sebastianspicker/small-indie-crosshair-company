...
import { MODELS, getModel, forward, geometryError, targetGeometry } from '../../lib/solver/renderer.js';
import { solveInverse, exactPreimage, exactPreimageForAll } from '../../lib/solver/inverse.js';
...
test('existing solveInverse results are unchanged', () => {
  ...
  // Three-gap example: tests/lib/quant.test.mjs line 23.
  ...
  // Literal zero remains the minimum-thickness branch: tests/lib/quant.test.mjs line 27.
  ...
  // Unrepresentable bounds: tests/lib/quant.test.mjs line 28.
