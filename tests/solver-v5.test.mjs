...
import { compileShape, compileMask, compareShapes, validateMask } from '../lib/pixel-shape.js';
import { raster, compareMasks } from '../lib/raster.js';
import { infer, exportQuantCFG } from '../lib/quant/inference.js';
import { DEFAULT_SETTINGS } from '../lib/cfg.js';
import { MODELS, forward, getModel, geometryError, scope } from '../lib/quant/renderer.js';
import { solveInverse, solveTarget } from '../lib/quant/inverse.js';
import { posterior, robustLogLikelihood } from '../lib/quant/evidence.js';
import { validateMeasurements } from '../lib/quant/observations.js';
import { visualContext } from '../lib/quant/visual.js';
import { rankCandidates } from '../lib/quant/selection.js';
...
test('native pure-dot path rejects an unexplained noisy mask, just like the bar path',async()=>{
 const {measureNativeMask}=await import('../lib/quant/screenshot.js');
