...
import { raster, rectangles, drawingEdges, RASTER_CONVENTION, RAW_EDGE_CONVENTION } from '../lib/raster.js';
import { compareShapes, compileShape, compileMask } from '../lib/pixel-shape.js';
import { legacyGeometry } from '../lib/legacy.js';
import { predictedGeometry } from '../lib/conversion.js';
import { analyzeScreenshot } from '../lib/quant/screenshot.js';
