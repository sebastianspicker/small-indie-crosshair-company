...
export function validateNative(n) {
  integer(n.length,'New length',NATIVE_RANGES.length.min,NATIVE_RANGES.length.max);
  integer(n.thickness,'New thickness',NATIVE_RANGES.thickness.min,NATIVE_RANGES.thickness.max);
  integer(n.gap,'New gap',NATIVE_RANGES.gap.min,NATIVE_RANGES.gap.max);
