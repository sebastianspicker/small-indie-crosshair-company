 ...
 * docs/engineering/v0.4-conversion-improvement-plan.md §2.7 and
 * docs/math/10-learned-emulator.md.
 *
 * This module is deliberately NOT imported by `lib/quant/inference.js` or by `lib/quant/modulator.js`.
...
import { structuralForward } from './structural.js';
