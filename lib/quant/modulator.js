 ...
 *
 * It is deliberately NOT imported by `lib/quant/inference.js`, and it must stay that way.
 ...
 * docs/engineering/v0.4-conversion-improvement-plan.md §2.7.
 *
 ...
 *
 * The bounded-delta predicate lives in `lib/quant/modulation-contract.js`. It is a separate
 * pure contract, not a second reason to open this gate, and `modulate` does not call it.
 */
import { INVENTORY_BUILD } from '../cvar-inventory.js';
