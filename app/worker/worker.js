...
import { discriminatingSet } from '../../lib/solver/experiments.js';
import { analyzeScreenshot, analyzeNativeScreenshot } from '../../lib/image/screenshot.js';
import { assertPayloadSize, estimatePayloadBytes } from './limits.js';
let records = null;
const operations = {
  init(payload) {
