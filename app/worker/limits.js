 ...
 * evidence-input cap in docs/engineering/architecture.md. This is transport policy owned by
 * the worker boundary, not domain logic, but it stays pure so it can be unit-tested without
 * a browser or a live worker.
 */
