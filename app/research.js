...
export function initResearch() {
  ...
  root.append(el('section',{class:'math-sheet'},el('h2',{},'Certifying the declared search, and a capture plan'),
    el('p',{},'The shipped search is bounded and fast, but it is not always the global optimum of the declared loss. Re-solving 1064 corpus cases shows the certified best beat the shipped choice in 114 (about 10.7%), almost all under the worst-case rule. An opt-in expansion can certify the declared optimum or refuse to claim one; the default path is deliberately unchanged. The shell-monotone certificate rests on a documented, spot-checked monotonicity assumption, not a proof. All of this concerns our own declared objective, never Valve’s renderer.'),
